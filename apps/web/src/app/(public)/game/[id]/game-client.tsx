  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="px-4 py-6 pb-24">
        ...
        {/* Game Media Section - Only show if photos or Instagram links exist */}
        {((game as { photos_url?: string | null }).photos_url || (game as { instagram_url?: string | null }).instagram_url) && (
